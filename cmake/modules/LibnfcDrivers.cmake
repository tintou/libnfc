...
IF(${CMAKE_SYSTEM_NAME} MATCHES "Linux")
  SET(LIBNFC_DRIVER_PN71XX OFF CACHE BOOL "Enable PN71xx support (Depends on libnfc-nci, Linux only)")
ENDIF(${CMAKE_SYSTEM_NAME} MATCHES "Linux")
SET(LIBNFC_DRIVER_NSR106_USB ON CACHE BOOL "Enable NSR106 USB HID support (wCopy NSR106 / 2SING family, Depends on libusb)")
...
IF(LIBNFC_DRIVER_NSR106_USB)
  FIND_PACKAGE(LIBUSB REQUIRED)
  ADD_DEFINITIONS("-DDRIVER_NSR106_USB_ENABLED")
  SET(DRIVERS_SOURCES ${DRIVERS_SOURCES} "drivers/nsr106_usb.c")
  SET(USB_REQUIRED TRUE)
ENDIF(LIBNFC_DRIVER_NSR106_USB)
